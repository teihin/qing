...
let count=0;
for(const hidden of [[],['业绩比例'],['我的盟主'],['总业绩','业绩比例'],['我的盟主','总业绩','业绩比例'],['我的盟主','总业绩','推广','业绩比例']]){
 ...
 assert.equal(new Set(active.map(n=>n.y)).size,Math.ceil(active.length/cols));count++;
}
console.log('PASS',count,'actual Cocos Grid permission combinations: 3–7 buttons, reading order, no gaps, 2–3 rows.');
